...
This library relies on a JAX-RS implementation (of your choice) with a Jackson JSON mapper. For a lightweight implementation, you can check https://github.com/robshep/logback-logdna[this other appender].

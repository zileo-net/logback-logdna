...
Finally, you have to provide a `LOGDNA_INGEST_KEY` (api key you'll create in your LogDNA console) and the `LOGDNA_INGEST_URL` (should be https://logs.logdna.com/logs/ingest) via your System properties or environment variables.
...
* You can also set up a specific `connectTimeout` and `readTimeout` for the underlying JAX-RS client.
